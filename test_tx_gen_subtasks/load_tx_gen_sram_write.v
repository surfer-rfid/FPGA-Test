...
//                                                                                     //
// Filename: load_tx_gen_sram_write.v                                                  //
...
task    load_tx_gen_sram_write;
    ...
    begin
        ...
        load_tx_gen_sram_write_16b(write_packet_bits,8'h20,data[0],3'b000,1'b0);    //EPC address is by bit as opposed to by byte, see Page 44/152, Fig. 6.19 of v2.0 of RFID spec.
        $display("Loaded write 16b %b at time %t",data[1],$realtime);
        load_tx_gen_sram_write_16b(write_packet_bits,8'h30,data[1],3'b001,1'b0);
        $display("Loaded write 16b %b at time %t",data[2],$realtime);
        load_tx_gen_sram_write_16b(write_packet_bits,8'h40,data[2],3'b010,1'b0);
        $display("Loaded write 16b %b at time %t",data[3],$realtime);
        load_tx_gen_sram_write_16b(write_packet_bits,8'h50,data[3],3'b011,1'b0);
        $display("Loaded write 16b %b at time %t",data[4],$realtime);
        load_tx_gen_sram_write_16b(write_packet_bits,8'h60,data[4],3'b100,1'b0);
        $display("Loaded write 16b %b at time %t",data[5],$realtime);
        load_tx_gen_sram_write_16b(write_packet_bits,8'h70,data[5],3'b101,1'b1);
    end
endtask