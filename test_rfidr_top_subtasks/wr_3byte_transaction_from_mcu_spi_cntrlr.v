/////////////////////////////////////////////////////////////////////////////////////////
//                                                                                     //
// Subtask : Write/read 3 bytes over MCU controller SPI                                //
//                                                                                     //
// Filename: wr_3byte_transaction_from_mcu_spi_cntrlr.v                                //
        ...
        begin
            ...
            fork    begin
                ...
                if(data_return_ideal != data_return)    begin
                    $display("The simulation failed: data returned %b did not equal ideal data %b ideal at time %t",data_return,data_return_ideal,$realtime);
                    $stop;
                end
