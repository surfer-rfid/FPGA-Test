/////////////////////////////////////////////////////////////////////////////////////////
//                                                                                     //
// Bench : Test RFIDr top level                                                        //
//                                                                                     //
// Filename: test_rfidr_top.v                                                          //
...
//                                                                                     //
//    090816 - File created                                                            //
//    092416 - Postfit version - need to rename signals that dig into the design       //
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    wire             cntrlr_copi_cap3_extl;
    wire             cntrlr_copi_cap2_extl;
    wire             cntrlr_copi_cap1_extl;
    wire             cntrlr_copi_cap0_rdio_extl;
    wire             cntrlr_cipo_extl;
    wire             cntrlr_nps_rdio_extl;
    wire             cntrlr_nps_dtc_extl;
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    assign    tx_go                  =    rfidr_top0.radio_fsm0_atx_go_aq;
    assign    tx_en                  =    rfidr_top0.radio_fsm0_atx_en_aq;
    assign    clk_4p5                =    rfidr_top0.clk_and_reset_mgmt0_aclk_mgmt0_aclk_buf_4p5_aaltclkctrl_0_aclk_gate_buf_altclkctrl_0_sub_component_awire_clkctrl1_outclk;
    assign    out_i_baseband_4p5     =    rfidr_top0.tx_gen0_aout_aq;
    assign    radio_state            =    rfidr_top0.radio_fsm0_astate;
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    `include "../../../FPGA-Test/test_rfidr_top_subtasks/mcu_bfm_rfidr_top_postfit.v"
    `include "../../../FPGA-Test/test_rfidr_top_subtasks/wvfm_strg_ideal_bfm_postfit.v"
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    initial    begin
        wait(is_sram_loaded);
        mcu_bfm_rfidr_top_postfit(rn16_i_rx_bits_top, pcepc_rx_bits_top);
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    sx1257_rx_and_tag_bfm    sx1257_rx_and_tag_bfm_0
    (
        .is_radio_running(is_radio_running),
        .cntrlr_nps_rdio(cntrlr_nps_rdio_extl),
        .cntrlr_nps_dtc(cntrlr_nps_dtc_extl),
        .cntrlr_pclk(cntrlr_pclk_extl),
        .cntrlr_copi_cap3(cntrlr_copi_cap3_extl),
        .cntrlr_copi_cap2(cntrlr_copi_cap2_extl),
        .cntrlr_copi_cap1(cntrlr_copi_cap1_extl),
        .cntrlr_copi_cap0_rdio(cntrlr_copi_cap0_rdio_extl),
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    rfidr_top     rfidr_top0(
        ...
        .cntrlr_copi_cap3_pin(cntrlr_copi_cap3_extl),
        .cntrlr_copi_cap2_pin(cntrlr_copi_cap2_extl),
        .cntrlr_copi_cap1_pin(cntrlr_copi_cap1_extl),
        .cntrlr_copi_cap0_rdio_pin(cntrlr_copi_cap0_rdio_extl),
        .cntrlr_cipo_pin(cntrlr_cipo_extl),
        .cntrlr_nps_rdio_pin(cntrlr_nps_rdio_extl),
        .cntrlr_nps_dtc_pin(cntrlr_nps_dtc_extl)
    );
